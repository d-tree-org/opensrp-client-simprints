package org.smartregister.simprint.provider;
...
public class SimprintIdentificationRegisterProvider implements RecyclerViewProvider<SimprintIdentificationRegisterProvider.RegisterViewHolder> {
    ...
    private void populatePatientColumn(CommonPersonObjectClient pc, SmartRegisterClient client, final SimprintIdentificationRegisterProvider.RegisterViewHolder viewHolder) {
    ...
    private void populateIdentifierColumn(CommonPersonObjectClient pc, SimprintIdentificationRegisterProvider.RegisterViewHolder viewHolder) {
